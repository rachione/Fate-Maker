<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainStage.aspx.cs" Inherits="login" %>
...
<body>
    <form id="form1" runat="server">
                        ...
                        <li class="dropdown">
                          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pages<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li class="active" ><a href="/ASPX/MainStage.aspx">Main Stage</a></li>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FateMakerConnectionString %>" SelectCommand="SELECT * FROM [PlayerStage] WHERE ([user_id] = @user_id)">
            <SelectParameters>
