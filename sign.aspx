<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sign.aspx.cs" Inherits="login" %>
                ...
                <div class="panel panel-primary loginPanel">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group  row">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <asp:TextBox ID="PasswordConfirm" CssClass="form-control FKasplabel" runat="server" placeholder="Password confirm" TextMode="Password"></asp:TextBox>

                                </div>
                            </div>
                            <div class="form-group  row">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <div class="signalert  FKasplabel alert alert-danger" role="alert"></div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="panel-footer">
                        <div class="form-group  row clearfix">
                            <div class=" col-sm-offset-2 col-sm-8">
                                <a class="btn btn-link" href="login.aspx">Back</a>
